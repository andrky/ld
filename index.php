...
<head>
  ...
  <title>Virtual Jelajah Indonesia</title>
</head>
...
<body id="home">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark shadow-sm fixed-top" style="background-color: rgb(255, 0, 0)">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse ms-5 me-5 justify-content-end" id="navbarTogglerDemo02">
  ...
  <footer class="text-light pb-1 text-center" style="background-color: rgb(255, 0, 0)">
    <p>Powered with <i class="bi bi-heart-fill" style="color: white"></i> by <a href="#home" class="text-light fw-bold text-decoration-none">Virtual Jelajah Indonesia</a></p>
  </footer>
  <!-- Akhir Foooter -->
