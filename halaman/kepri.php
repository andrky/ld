...
<section id="peta">
  <div class="container">
    <div class="row">
      <div class="col mb-5">
        <h2>Peta Provinsi Kepulauan Riau</h2>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <img src="img/kepri/map_kepri.png" alt="Gambar Peta Riau" class="img-thumbnail shadow">
      </div>
    </div>
    <div class="row justify-content-center">
      <div class="col-md-2 mt-3 mb-4 ps-3 d-flex justify-content-md-center">
        <div class="kotak"></div>
        <div class="text ps-3">Kepulauan Riau
        </div>
      </div>
      <div class="col-md-2 mt-3 mb-4 ps-3 d-flex justify-content-md-center">
  ...
  <div class="container">
    ...
    <div class="row justify-content-evenly">
      <div class="col-md-6 mb-3">
        <div class="card border-light shadow p-3 h-100">
          <img src="img/kepri/tari_joget_lambak.png" class="card-img-top img-fluid rounded" alt="Gambar Logo Tari Joget Lambak" />
          <div class="card-body">
            <h4 class="card-title">Tari Joget Lambak</h4>
            <p class="card-text" style="text-align: justify;">Tari Joget Lambak adalah wujud ungkapan kegembiraan dengan memadukan tiga unsur, yaitu gerakan yang lincah, musik yang cepat, dan syair yang bermakna suka cita. Tari Joget Lambak kebanyakan dibawakan oleh penari wanita. Namun tidak menutup kemungkinan ada penari pria yang ikut bergabung dalam tarian ini.</p>
          </div>
        </div>
      </div>
      <div class="col-md-6 mb-3">
        <div class="card border-light shadow p-3 h-100">
          <img src="img/kepri/tari_malemang.png" class="card-img-top img-fluid rounded" alt="Gambar Logo Tari Malemang" />
          <div class="card-body">
            <h4 class="card-title">Tari Malemang</h4>
            <p class="card-text" style="text-align: justify;">Tari Tari Malemang adalah sebuah tariat adat yang Berasal dari Tanjungpisau Kab. Bintan Kepulauan Riau. Tari Malemang memadukan memadukan unsur tari, musik, dan menyanyi sehingga jika ditampilkan akan menampilkan sebuah pertunjukan seni yang indah.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="row justify-content-evenly">
      <div class="wisgam col-md-2">
        <img src="img/kepri/penyengat island.png" alt="Gambar Penyengat Island" class="img-fluid shadow-lg rounded">
        <h6>Penyengat Island</h6>
      </div>
      <div class="wisgam col-md-2">
        <img src="img/kepri/ria_bintan_golf_club.png" alt="Gambar Ria Bintan Golf Club" class="img-fluid shadow-lg rounded">
        <h6>Ria Bintan Golf Club</h6>
      </div>
      <div class="wisgam col-md-2">
        <img src="img/kepri/telaga_biru.png" alt="Gambar Telaga Biru" class="img-fluid shadow-lg rounded">
        <h6>Telaga Biru</h6>
      </div>
      <div class="wisgam col-md-2">
        <img src="img/kepri/trikora_beach.png" alt="Gambar Trikora Beach" class="img-fluid shadow-lg rounded">
        <h6>Trikora Beachu</h6>
      </div>
    </div>
  </div>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
    ...
    <div class="row justify-content-evenly">
      <div class="col-md-6 mb-3 rounded">
        <div class="card mb-3 mt-3 shadow h-100">
          <div class="row g-0">
            <div class="col-md-4">
              <img src="img/kepri/suku.png" class="img-fluid rounded-end" alt="Gambar Suku Laut">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h5 class="card-title">Suku Laut</h5>
                <p class="card-text" style="text-align: justify;">Suku Laut atau sering juga disebut Orang Laut adalah suku bangsa yang menghuni Kepulauan Riau, Indonesia. Secara lebih luas istilah Orang Laut mencakup "berbagai suku dan kelompok yang bermukim di pulau-pulau dan muara sungai di Kepulauan Riau-Lingga, Pulau Tujuh, Kepulauan Batam, dan pesisir dan pulau-pulau di lepas pantai Sumatra Timur dan Semenanjung Malaya bagian selatan. Sebutan lain untuk Orang Laut adalah Orang Selat. Orang Laut kadang-kadang dirancukan dengan suku bangsa maritim lainnya, Orang Lanun. Secara historis, Orang Laut dulunya adalah perompak, tetapi berperan penting dalam Kerajaan Sriwijaya, Kesultanan Malaka dan Kesultanan Johor. Mereka menjaga selat-selat, mengusir bajak laut, memandu para pedagang ke pelabuhan Kerajaan-kerajaan tersebut, dan mempertahankan hegemoni mereka di daerah tersebut.
                </p>
              </div>
            </div>
          </div>
    ...
    <div class="row justify-content-evenly">
      <div class="col-md-4 mb-3">
        <div class="card border-light shadow p-4 h-100">
          <img src="img/kepri/lakse.png" class="card-img-top img-fluid rounded shadow-sm" alt="Gambar Lakse" />
          <div class="card-body">
            <h5 class="card-text text-center pt-3">Lakse</h5>
          </div>
        </div>
      </div>
      <div class="col-md-4 mb-3">
        <div class="card border-light shadow p-4 h-100">
          <img src="img/kepri/luti_gendang.png" class="card-img-top img-fluid rounded shadow-sm" alt="Gambar Luti Gendang" />
          <div class="card-body">
            <h5 class="card-text text-center pt-3">Luti Gendang</h5>
          </div>
        </div>
      </div>
      <div class="col-md-4 mb-3">
        <div class="card border-light shadow p-4 h-100">
          <img src="img/kepri/mie_lendir.png" class="card-img-top img-fluid rounded shadow-sm" alt="Gambar Mie Lendir" />
          <div class="card-body">
            <h5 class="card-text text-center pt-3">Mie Lendir</h5>
          </div>
        </div>
      </div>
    </div>
