...
<section id="peta">
  <div class="container">
    <div class="row">
      <div class="col mb-5">
        <h2>Peta Provinsi Sumatera Barat</h2>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <img src="img/sumbar/map_sumbar.png" alt="Gambar Peta Sumatera Barat" class="img-thumbnail shadow">
      </div>
    </div>
    <div class="row justify-content-center">
      <div class="col-md-2 mt-3 mb-4 ps-3 d-flex justify-content-md-center">
        <div class="kotak"></div>
        <div class="text ps-3">Sumatera Barat
        </div>
      </div>
      <div class="col-md-2 mt-3 mb-4 ps-3 d-flex justify-content-md-center">
    ...
    <div class="row justify-content-center">
      <div class="col-md-7 mb-5">
        <div class="card shadow" style="width: auto">
          <img src="img/sumbar/rumah_adat.png" class="card-img-top rounded" alt="Gambar Rumah Adat Sumatera Barat">
          <div class="card-body">
            <p class="card-text fs-6" style="text-align: justify;">Rumah Gadang adalah nama untuk rumah adat Minangkabau yang merupakan rumah tradisional dan banyak jumpai di Sumatra Barat, Indonesia. Rumah ini juga disebut dengan nama lain oleh masyarakat setempat dengan nama Rumah Bagonjong atau ada juga yang menyebut dengan nama Rumah Baanjuang. Rumah dengan model ini juga banyak dijumpai di Sumatra Barat, Namun tidak semua kawasan di Minangkabau (darek) yang boleh didirikan rumah adat ini, hanya pada kawasan yang sudah memiliki status sebagai nagari saja Rumah Gadang ini boleh didirikan. Begitu juga pada kawasan yang disebut dengan rantau, rumah adat ini juga dahulunya tidak ada yang didirikan oleh para perantau Minangkabau.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="row justify-content-evenly">
      <div class="col-md-6 mb-3">
        <div class="card border-light shadow p-3 h-100">
          <img src="img/sumbar/tari_indang.png" class="card-img-top img-fluid rounded" alt="Gambar Tari Indang" />
          <div class="card-body">
            <h4 class="card-title">Tari Indang</h4>
            <p class="card-text" style="text-align: justify;">Tari Indang atau yang lebih dikenal dengan Tari Dindin Badindin ini merupakan salah satu tari tradisional yang berasal dari Pariaman, Provinsi Sumatera Barat. Indang sendiri berarti gendang kecil, tarian ini mirip dengan Tari Saman yang berasal dari Aceh namun memiliki gerakan yang lebih santai.</p>
          </div>
        </div>
      </div>
      <div class="col-md-6 mb-3">
        <div class="card border-light shadow p-3 h-100">
          <img src="img/sumbar/tari_rancak.png" class="card-img-top img-fluid rounded" alt="Gambar Logo Tari Rancak" />
          <div class="card-body">
            <h4 class="card-title">Tari Rancak</h4>
            <p class="card-text" style="text-align: justify;">Tari Rancak ini terkenal akan keindahan dan ketegasan dalam gerakannya. Pada umumnya tari rancak diperankan oleh perempuan Minang menggunakan pakain berwarna cerah. Ada tujuan dari tarian ini, yaitu untuk menunjukkan selain dirinya yang tegas, bahwa dirinya juga anggun.</p>
          </div>
        </div>
      </div>
    </div>
...
<section id="wisata">
  <div class="container">
    ...
    <div class="row justify-content-evenly">
      ...
      <div class="wisgam col-md-2">
        <img src="img/sumbar/lobang_jepang.png" alt="Gambar Lobang Jepang" class="img-fluid shadow-lg rounded">
        <h6>Lobang Jepang</h6>
      </div>
      <div class="wisgam col-md-2">
        <img src="img/sumbar/pantai_air_manis.png" alt="Gambar Pantai Air Manis" class="img-fluid shadow-lg rounded">
        <h6>Pantai Air Manis</h6>
      </div>
      <div class="wisgam col-md-2">
        <img src="img/sumbar/siti_nurbaya_bridge.png" alt="Gambar Siti Nurbaya Bridge" class="img-fluid shadow-lg rounded">
        <h6>Siti Nurbaya Bridge</h6>
      </div>
      <div class="wisgam col-md-2">
        <img src="img/sumbar/gunung_tujuh.png" alt="Gambar Gunung Tujuh" class="img-fluid shadow-lg rounded">
        <h6>Gunung Tujuh</h6>
      </div>
      <div class="wisgam col-md-2">
        <img src="img/sumbar/jam gadang.png" alt="Gambar Jam Gadang" class="img-fluid shadow-lg rounded">
        <h6>Jam Gadang</h6>
      </div>
    </div>
  </div>
    ...
    <div class="row justify-content-evenly">
      <div class="col-md-4 mb-3">
        <div class="card border-light shadow p-4 h-100">
          <img src="img/sumbar/rendang.png" class="card-img-top img-fluid rounded shadow-sm" alt="Gambar Rendang" />
          <div class="card-body">
            <h5 class="card-text text-center pt-3">Rendang</h5>
          </div>
        </div>
      </div>
      <div class="col-md-4 mb-3">
        <div class="card border-light shadow p-4 h-100">
          <img src="img/sumbar/sate_padang.png" class="card-img-top img-fluid rounded shadow-sm" alt="Gambar Sate Padang" />
          <div class="card-body">
            <h5 class="card-text text-center pt-3">Sate Padang</h5>
          </div>
        </div>
      </div>
      <div class="col-md-4 mb-3">
        <div class="card border-light shadow p-4 h-100">
          <img src="img/sumbar/ayam_pop.png" class="card-img-top img-fluid rounded shadow-sm" alt="Gambar Ayam Pop" />
          <div class="card-body">
            <h5 class="card-text text-center pt-3">Ayam Pop</h5>
          </div>
        </div>
      </div>
    </div>
